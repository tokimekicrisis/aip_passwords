...
Database::Database(const char* filename) {
    ...
    if(rc != SQLITE_OK){
        ...
        printf("table made successfully");
        }                
}
...
bool Database::insert_data(const char* site, const char* pw, const char* cat, const char* cmt) {
    sqlite3_stmt* stmt;
...
// bool Database::extract_data(const char* column, const char* data) {
//     sqlite3_stmt* stmt;

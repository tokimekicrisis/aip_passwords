...
#include "../../../../include/ui/table_model.h"
...
template <> constexpr inline auto TableModel::qt_create_metaobjectdata<qt_meta_tag_ZN10TableModelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'updateFromDatabase'
        QtMocHelpers::SlotData<void(Database *, const char *, const char *)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { 0x80000000 | 5, 6 }, { 0x80000000 | 5, 7 },
        }}),
        // Slot 'updateFromDatabase'
        QtMocHelpers::SlotData<void(Database *, const char *)>(1, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { 0x80000000 | 5, 6 },
        }}),
        // Slot 'updateFromDatabase'
        QtMocHelpers::SlotData<void(Database *)>(1, 2, QMC::AccessPublic | QMC::MethodCloned, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void TableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->updateFromDatabase((*reinterpret_cast< std::add_pointer_t<Database*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<const char*>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<const char*>>(_a[3]))); break;
        case 1: _t->updateFromDatabase((*reinterpret_cast< std::add_pointer_t<Database*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<const char*>>(_a[2]))); break;
        case 2: _t->updateFromDatabase((*reinterpret_cast< std::add_pointer_t<Database*>>(_a[1]))); break;
        default: ;
        }
    }
}
